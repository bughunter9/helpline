...
contract Marketplace {
    ...
    function createProduct(string memory _name, uint _price, string memory _proof) public {
        ...
        productCount ++;
        // Create the product
        products[productCount] = Product(productCount, _name, _price, msg.sender, _proof, false);
        // Trigger an event
    ...
    function purchaseProduct(uint _id) public payable {
        ...
        // Trigger an event
        emit ProductPurchased(productCount, _product.name, _product.price, msg.sender, _product.proof, true);
    }
}
